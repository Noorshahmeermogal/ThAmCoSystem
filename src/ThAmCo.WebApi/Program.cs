...
Console.WriteLine("USING CONNECTION: Server=tcp:thamcosy.database.windows.net,1433;Initial Catalog=ThAmCoDB;Persist Security Info=False;User ID=ThAmCoDB;Password=Admin3214567;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
...
using (var scope = app.Services.CreateScope())
{
    ...
    // Seed a default staff user for testing
    if (!context.Staff.Any(s => s.Email == "staff@thamco.com"))
    {
        context.Staff.Add(new ThAmCo.WebApi.Models.Staff
        {
            ...
            // For this demo, we'll assume a simple check in AuthService.
            Password = "staff123", 
            Role = "Staff",
            IsActive = true,
...
Console.WriteLine($"Application is running on http://localhost:5000");
app.Run();
    }
}
